...
*/
        ...
        int tmp_trig = (la_hi_interrupt_state.gpio_pin_cfg_backup_data >> 7) & 0x7;
        ...
        xTaskCreatePinnedToCore(ll_triggered_isr_alloc, "trigg_alloc", 4096, NULL, 20, NULL, la_hi_interrupt_state.cpu);
    }
}

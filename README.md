...
## Main parameters
  ...
  ## Sigrok PulseView can be used as visualization and protocol analyzer
   ...
   - test_sample_init() - includes a simple 500 kHz generator, a burst of GPIO pulses with a high duty cycle, and a burst of GPIO pulses generated by interrupts. No additional connections, wiring, etc. are needed, it will already show the insides. If you wish, you can put 2 jumpers on the pins (18-22,19-23) - it will duplicate the signals on the GPIO.

...
- Считывание данных в параллельном режиме 8/16 бит модулем LCD/CAM, требуется один GPIO для сигнала PCLK
- Для частоты сэмплов меньше 1 MHz требуется один канал LEDC
- Можно выбрать режим триггера IRQ/ETM, режим ETM требует еще один дополнительный свободный GPIO
